    ...
    return(
        <section className="flex flex-col items-center justify-center gap-12 px-6 xl:px-12">
            <div className='flex flex-col xl:flex-row justify-center items-start gap-2'>
                <button
                    className={`px-6 py-4 rounded-xl text-md font-medium text-slate-900 ${activetab === "ats" ? 'bg-primary text-white' : 'text-slate-900'}`}
                    onClick={() => setActiveTab("ats")}
                    >Automatic Transfer Switch
                </button>
                <button
                    className={`px-6 py-4 rounded-xl text-md font-medium text-slate-900 ${activetab === "mccb" ? 'bg-primary text-white' : 'text-slate-900'}`}
                    onClick={() => setActiveTab("mccb")}
                    >Molded Case Circuit Breaker
                </button>
                <button
                    className={`px-6 py-4 rounded-xl text-md font-medium text-slate-900 ${activetab === "ucb" ? 'bg-primary text-white' : 'text-slate-900'}`}
                    onClick={() => setActiveTab("ucb")}
                    >Universal Circuit Breaker
                </button>
                <button
                    className={`px-6 py-4 rounded-xl text-md font-medium text-slate-900 ${activetab === "mcb" ? 'bg-primary text-white' : 'text-slate-900'}`}
