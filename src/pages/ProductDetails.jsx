        ...
        <section className="font-primary m-0 p-0 box-border">
            <div className="flex flex-col">
                ...
                <div className="flex flex-col items-center justify-center gap-6 px-6 py-12">
                    ...
                    {selectedProduct ? (
                        <div className="w-full bg-white p-6 rounded-lg shadow flex flex-col xl:flex-row">
                            <img src={selectedProduct.image} alt={selectedProduct.name} className="w-1/5 h-auto object-cover rounded-lg mb-6" />
                            <div className='flex flex-col justify-start'>
                                ...
                                <p className="text-md mb-4"><strong>Brand:</strong> {selectedProduct.brand || "Aisikai"}</p>
                                <p className="text-md mb-4"><strong>Description:</strong> {selectedProduct.description || "No description available."}</p>
                                <a
                        ...
                        <div className="w-full lg:w-2/3 bg-gray-100 p-4 rounded-lg shadow">
